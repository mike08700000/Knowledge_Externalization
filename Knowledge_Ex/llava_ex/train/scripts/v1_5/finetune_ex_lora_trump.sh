...
epoch=1
memory_tokens=128
CHECKPOINT_BASE="/datanfs2/medllava/llava/Externalization_llava/checkpoints/llava-v1.5-7b-lora-June29-trump-bs8-extraction-${lr_rate}-epoch${epoch}-memorytokens${memory_tokens}-largedata1"
