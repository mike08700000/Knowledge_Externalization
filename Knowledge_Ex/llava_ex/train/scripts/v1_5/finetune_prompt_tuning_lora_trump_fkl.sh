...
epoch=19
memory_tokens=128
CHECKPOINT_BASE="/datanfs2/medllava/llava/Externalization_llava/checkpoints/llava-v1.5-7b-lora-June19-trump-bs4-extraction-${lr_rate}-epoch${epoch}-memorytokens${memory_tokens}-FirstKL"

export PYTHONPATH="/datanfs2/medllava/llava/Externalization_llava"
deepspeed --include=localhost:3,4,6,7 llava/train/train_mem_fkl.py \
    ...
    --data_path /datanfs2/medllava/llava/mutimodal_dataset/trump/dataGA66.json \
