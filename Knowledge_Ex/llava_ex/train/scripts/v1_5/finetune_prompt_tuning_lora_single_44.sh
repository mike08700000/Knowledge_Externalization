...
for epoch in 4; do
    for lr_rate in 1e-4; do
        for dataset in Kitty;do

            CHECKPOINT_BASE="/datanfs2/medllava/llava/Externalization_llava/new_single_checkpoints/tmd-llava-v1.5-7b-lora-Sep8-1-${dataset}-bs4-extraction-${lr_rate}-epoch${epoch}-memorytokens${memory_tokens}-singlecard"
