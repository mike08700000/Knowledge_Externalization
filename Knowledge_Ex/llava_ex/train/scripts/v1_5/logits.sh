...
python /datanfs2/medllava/llava/Externalization_llava/llava/eval/eval_logiits.py \
    ...
    --answers-file "${CHECKPOINT_BASE}/logits_new.jsonl" \
    --use_lora \
    ...
    --temperature 0 \
    --save-folder "${CHECKPOINT_BASE}/causal_tracing_results" \
    --conv-mode vicuna_v1
...
#     --image-folder /data2/dmz/llava_test/LLaVA-main \
#     --answers-file "${CHECKPOINT_BASE}/testall_with_memory_tokens_inference0605.jsonl" \
#     --no_use_lora \
#     --use_prompt_tuning \
#     --num_virtual_tokens 20 \
#     --prompt_tuning_init_text "What's in the image" \
