...
for epoch in 12 ; do
    for lr_rate in 2e-4; do
        for dataset in Biden;do

            CHECKPOINT_BASE="/datanfs2/medllava/llava/Externalization_llava/new_single_checkpoints/baseline3-llava-v1.5-7b-lora-Sep8-1-${dataset}-bs4-extraction-${lr_rate}-epoch${epoch}-memorytokens${memory_tokens}-singlecard"
