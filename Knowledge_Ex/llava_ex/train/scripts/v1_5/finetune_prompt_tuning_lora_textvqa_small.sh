...
deepspeed --include=localhost:4,5,6,7 llava/train/train_mem.py \
    ...
    --data_path /datanfs2/medllava/llava/mutimodal_dataset/textvqa/June10.json \
    ...
    --bf16 True \
    --output_dir ./checkpoints/llava-v1.5-7b-lora-June12-textvqa-bs8-extraction-1e-4-kl-loss_adapt \
    --num_train_epochs 1 \
