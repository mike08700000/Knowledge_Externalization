...
deepspeed --include=localhost:4,5,6,7 llava/train/train_mem.py \
    ...
    --data_path /datanfs2/medllava/llava/mutimodal_dataset/textvqa/train_samples_textvqa.json \
    --image_folder /datanfs2/dmz/datapri \
    ...
    --bf16 True \
    --output_dir ./checkpoints/llava-v1.5-7b-lora-June12-textvqa-bs8-extraction-4e-5-full \
    --num_train_epochs 1 \
