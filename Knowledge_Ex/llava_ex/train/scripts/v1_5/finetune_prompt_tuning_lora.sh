...
deepspeed --include=localhost:0,1,2,3 ./llava/train/train_mem.py \
    ...
    --data_path /datanfs2/medllava/llava/mutimodal_dataset/textvqa/sample_gpu_mem_textvqa_new.json \
    --image_folder /datanfs2/medllava/llava/mutimodal_dataset/textvqa/sampled_images \
    ...
    --bf16 True \
    --output_dir ./checkpoints/llava-v1.5-7b-lora-pt65-test \
    --num_train_epochs 1 \
